...
// "Retrieve Desired Record Set"
    ...
    $strSQL = "SELECT ID, Category, Image, Price, Description, "
            . "Option1Desc, Option1a, Option1b, Option1c, Option1d, "
            . "Option2Desc, Option2a, Option2b, Option2c, Option2d "
...
// "Display Individual Records"
    ...
    while ($rowProd = mysqli_fetch_array($rsProd)) {
        ...
        if ($rowProd["Option1Desc"] != "") {
            echo  '<br clear=all />'.$rowProd["Option1Desc"].'::' ;
            echo '<ul>';

            if ($rowProd["Option1a"] != "") {
                echo '</li>' . $rowProd["Option1a"] . '</li><br>';
            }
            if ($rowProd["Option1b"] != "") {
                echo 
                '</li>' . $rowProd["Option1b"] . '</li><br>';
            }
            if ($rowProd["Option1c"] != "") {
                echo '</li>' . $rowProd["Option1c"] . '</li><br>';
            }
            if ($rowProd["Option1d"] != "") {
                echo '</li>' . $rowProd["Option1d"] . '</li><br>';
            }
            echo '</ul>';
        }
        ...
        if ($rowProd["Option2Desc"] != "") {
            echo  '<br clear=all />'.$rowProd["Option2Desc"] . '::<br />';
            echo '<ul>';

            if ($rowProd["Option2a"] != "") {
                echo '</li>' . $rowProd["Option2a"] . '</li><br />';
            }
            if ($rowProd["Option2b"] != "") {
                echo '</li>' . $rowProd["Option2b"] . '</li><br/>';
            }
            if ($rowProd["Option2c"] != "") {
                echo '</li>' . $rowProd["Option2c"] . '</li><br/>';
            }
            if ($rowProd["Option2d"] != "") {
                echo '</li>' . $rowProd["Option2d"] . '</li><br/>';
            }
            echo '</ul>';
        }
    } // End of the while		
