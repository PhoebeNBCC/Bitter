                ...
                <div class="col-md-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="img-rounded" id="diplayMessage">
                            ...
                            <?php
                            $tweet = new Tweet();
                            echo "<h3>Who liked your tweets?</h3><br>";
                            $tweet->displayLike($_SESSION['SESS_MEMBER_ID']);
                            echo "<h3>Who retweeted your tweets?</h3><br>";
                            $tweet->displayRetweets($_SESSION['SESS_MEMBER_ID']);
                            echo "<h3>Who replied your tweets?</h3><br>";
                            $tweet->displayReply($_SESSION['SESS_MEMBER_ID']);
                            ?>
                        </div>
                    </div>
                    <div class="col-md-3">
